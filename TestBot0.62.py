                ...
                if user[0] == message.author:
                    if message.content[2:] == "g":
                        ...
                        try:
                            ...
                            await message.reply("invalid frequency")
            await message.channel.send("You have not yet signed up, please send a message containing just your Club ID first, before trying to adjust the frequency!")
            return
        else:
            await message.channel.send("Not valid club ID")
            return
